...
**Forked From https://github.com/AlexeyAB/darknet**  
**DeanShoes 訓練鞋子weights https://drive.google.com/file/d/1oOQwrX4s8UXXe4jX8wlbPO98fqwQbo7H/view?usp=sharing**

[![CircleCI](https://circleci.com/gh/AlexeyAB/darknet.svg?style=svg)](https://circleci.com/gh/AlexeyAB/darknet)

- [Yolo-v3 and Yolo-v2 for Windows and Linux](#yolo-v3-and-yolo-v2-for-windows-and-linux)
    - [(neural network for object detection)](#neural-network-for-object-detection)
- ["You Only Look Once: Unified, Real-Time Object Detection (versions 2 & 3)"](#you-only-look-once-unified-real-time-object-detection-versions-2--3)
        - [Requires:](#requires)
        - [Pre-trained models for different cfg-files can be downloaded from (smaller -> faster & lower quality):](#pre-trained-models-for-different-cfg-files-can-be-downloaded-from-smaller---faster--lower-quality)
        - [Examples of results:](#examples-of-results)
    - [How to use:](#how-to-use)
        - [Example of usage in cmd-files from `build\darknet\x64\`:](#example-of-usage-in-cmd-files-from-builddarknetx64)
